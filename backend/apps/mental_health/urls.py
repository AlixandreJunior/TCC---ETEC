...
urlpatterns = [
    ...
    path('diary/detail/<str:title>/', diary.DiaryObjectView.as_view(), name = 'diary_object'),
    path('diary/detail/<str:title>/update/', diary.DiaryUpdateView.as_view(), name = 'diary_update'),
